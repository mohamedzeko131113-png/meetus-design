  ...
  return (
    <div className="fixed inset-0 overflow-auto">
      ...
      <div className="hidden items-start justify-center lg:flex">
        ...
        >
        {/* Ellipse 2486 */}
        <div className="pointer-events-none absolute left-[38px] top-[-372px] -z-10 h-[807px] w-[807px] rounded-full bg-[#9E77F6] opacity-60" style={{ filter: "blur(860px)" }} />
        {/* Ellipse 2487 */}
        <div className="pointer-events-none absolute left-[-117px] top-[646px] -z-10 h-[813px] w-[813px] rounded-full bg-[#B0D2E5] opacity-60" style={{ filter: "blur(860px)" }} />
        {/* Ellipse 2488 */}
        <div className="pointer-events-none absolute left-[1083px] top-[667px] -z-10 h-[667px] w-[667px] rounded-full bg-[#9E77F6]" style={{ filter: "blur(240px)" }} />
        {/* Ellipse 2489 */}
        <div className="pointer-events-none absolute left-[638px] top-[-247px] -z-10 h-[667px] w-[667px] rounded-full bg-[#E477F6]" style={{ filter: "blur(240px)" }} />
        {/* Center highlight to match Figma soft vertical wash */}
        <div
          className="pointer-events-none absolute inset-0 -z-10"
          style={{
            background: `radial-gradient(600px 600px at 720px 512px, rgba(255,255,255,0.35) 0%, rgba(255,255,255,0) 70%), linear-gradient(90deg, rgba(255,255,255,0.06) 48%, rgba(255,255,255,0.02) 52%)`,
          }}
        />
        ...
        <div className="absolute left-[126px] top-[459.5px] flex h-[57px] w-[381px] items-center gap-3 rounded-[8px] border border-white bg-white/40 px-4">
          <span className="inline-flex h-6 w-6 items-center justify-center">
            <Image src="/icons/sms.png" alt="email icon" width={24} height={24} />
          </span>
          <input
            type="email"
            placeholder="Email"
        ...
        <div className="absolute left-[126px] top-[536.5px] flex h-[57px] w-[381px] items-center gap-3 rounded-[8px] border border-white bg-white/40 px-4">
          <span className="inline-flex h-6 w-6 items-center justify-center">
            <Image src="/icons/lock.png" alt="password icon" width={24} height={24} />
          </span>
          <input
            type="password"
      ...
      <div className="flex h-full min-h-screen w-full flex-col items-center justify-start gap-6 p-6 lg:hidden">
        {/* Solid background matches Figma (#E9ECF2) via body; no overlay */}
          ...
          <div className="flex w-full flex-col gap-4">
            <div className="flex h-12 w-full items-center gap-3 rounded-lg border border-white/80 bg-white/50 px-4 backdrop-blur">
              <span className="inline-flex h-5 w-5 items-center justify-center">
                <Image src="/icons/sms.png" alt="email icon" width={20} height={20} />
              </span>
            ...
            <div className="flex h-12 w-full items-center gap-3 rounded-lg border border-white/80 bg-white/50 px-4 backdrop-blur">
              <span className="inline-flex h-5 w-5 items-center justify-center">
                <Image src="/icons/lock.png" alt="password icon" width={20} height={20} />
              </span>
